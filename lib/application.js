...
app.enableAuth = function(options) {
  ...
  var remotes = this.remotes();
  var app = this;
  var UserBase = app.registry.getModel('User');
  ...
  if (options && options.dataSource) {
    ...
    AUTH_MODELS.forEach(function(m) {
      ...
      var isUserModel = Model.prototype instanceof UserBase.prototype;
      if ('logoutSessionsOnSensitiveChanges' in options && isUserModel) {
        Model.settings.logoutSessionsOnSensitiveChanges =
          options.logoutSessionsOnSensitiveChanges;
      }
